...
QUESTIONS = [
    ('Posicione seus pés na marca e espere o sinal, como mostrado ',
     'a abaixo, para medirmos seu peso e altura.'),
    ('Posicione o seu braço, como mostrado abaixo, para medirmos ',
     'seus dados vitais.'),
    ('Posicione seu braço na braçadeira, como mostrado abaixo, ',
     'para medirmos sua pressão.')
]
...
def test_question_gif(client):
    for idx, question in enumerate(QUESTIONS):
        assert map_question_animation(question) == GIF[idx]
